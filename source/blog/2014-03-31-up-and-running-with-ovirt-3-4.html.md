...
__Storage:__ The hosted engine feature requires NFS storage to house the VM that will host the engine. For this walkthrough, I'll be using an external NFS server for this -- I'll examine the topic of a setup with fully-converged storage, courtesy of GlusterFS, in a separate post.
...
Stay tuned for a followup post about GlusterFS & converged storage.
