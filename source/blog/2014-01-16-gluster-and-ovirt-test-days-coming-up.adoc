...
Speaking of oVirt, the project has its own test day coming up on January 24th, this one for the project's http://www.ovirt.org/OVirt_3.4_release_management[3.4 release]. 
